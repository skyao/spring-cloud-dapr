...
import static io.dapr.spring.cloud.config.client.ConfigServerConfigDataLoader.CONFIG_CLIENT_PROPERTYSOURCE_NAME;
import static io.dapr.spring.cloud.config.client.ConfigServerConfigDataLocationResolver.PREFIX;
